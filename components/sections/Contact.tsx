          ...
          <div className="space-y-12">
            ...
            <div className="flex gap-4">
              <a
                ...
                target="_blank"
                className="flex-1 flex items-center justify-center gap-2 py-3 bg-white/5 border border-white/10 rounded-sm text-zinc-400 hover:text-white hover:border-red-600/50 transition-all backdrop-blur-sm"
              >
