...
export default function Contact() {
  ...
  return (
    // ↓ pb-0 elimina el espacio entre Contact y Footer
    <section
      id="contacto"
      className="relative w-full pt-24 lg:pt-32 pb-20 bg-[#050505] overflow-hidden border-t border-white/5"
    >
      {/* Aurora roja animada */}
          ...
          <div className="space-y-12">
            <div>
              <h2 className="text-red-600 font-bold text-sm tracking-widest uppercase mb-4 flex items-center gap-2">
                <span className="w-8 h-[2px] bg-red-600" /> Contacto
              </h2>
              ...
              <div className="group relative bg-zinc-900/40 border border-white/5 p-6 rounded-2xl backdrop-blur-sm hover:border-red-500/30 transition-all duration-300">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-base text-white font-medium truncate">danielrayo247@gmail.com</div>
                  </div>
                  <button onClick={copyToClipboard} className="p-2 text-zinc-500 hover:text-white transition-colors" title="Copiar email">
                    {copiedEmail ? <CheckCircle size={18} className="text-green-500" /> : <Copy size={18} />}
                  </button>
                </div>
              </div>
            </div>
