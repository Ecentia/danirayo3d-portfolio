...
// --- ICONOS CUSTOM (SUBSTANCE) ---
// Aumentados a 1.8em para que se vean grandes y bonitos
const SubstanceDesignerIcon = (props: any) => (
  <svg viewBox="0 0 512.47 499.66" fill="currentColor" width="1.8em" height="1.8em" {...props}>
    <defs>
      <mask id="mask-tech-designer">
    ...
    <rect width="512.47" height="499.66" rx="90.75" fill="currentColor" mask="url(#mask-tech-designer)" />
  </svg>
);
...
const SubstancePainterIcon = (props: any) => (
  <svg viewBox="0 0 512.47 499.66" fill="currentColor" width="1.8em" height="1.8em" {...props}>
    ...
    <path d="M90.75,0h331a90.75,90.75,0,0,1,90.75,90.75V408.91a90.75,90.75,0,0,1-90.75,90.75h-331A90.75,90.75,0,0,1,0,408.91V90.75A90.75,90.75,0,0,1,90.75,0Z" fill="currentColor" mask="url(#mask-tech-painter)"/>
  </svg>
);

// --- CATEGORÍAS ORGANIZADAS (Sin Code & Core) ---
